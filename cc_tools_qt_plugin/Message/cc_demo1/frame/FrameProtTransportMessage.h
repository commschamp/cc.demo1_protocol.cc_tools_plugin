...
struct FrameProtTransportMessageFields
{
    using All =
        std::tuple<
            typename ::cc_demo1::frame::FrameLayers<TOpt>::SyncMembers::Sync,
            typename ::cc_demo1::frame::FrameLayers<TOpt>::SizeMembers::Size,
            ::cc_demo1::field::MsgId<TOpt>,
            typename ::cc_demo1::frame::FrameLayers<TOpt>::Data::Field,
            typename ::cc_demo1::frame::FrameLayers<TOpt>::ChecksumMembers::Checksum
        >;
};
