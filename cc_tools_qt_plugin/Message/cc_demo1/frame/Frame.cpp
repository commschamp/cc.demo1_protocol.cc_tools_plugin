...
#include "cc_tools_qt_plugin/Message/cc_demo1/factory/MsgFactory.h"
#include "cc_tools_qt_plugin/Message/cc_demo1/frame/FrameTransportMessage.h"
...
using ProtFrame =
    ::cc_demo1::frame::Frame<
        cc_tools_qt_plugin::Message::cc_demo1::Message::ProtInterface,
        ::cc_demo1::input::AllMessages<cc_tools_qt_plugin::Message::cc_demo1::Message::ProtInterface, cc_tools_qt_plugin::cc_demo1::options::DefaultOptions>,
        cc_tools_qt_plugin::cc_demo1::options::DefaultOptions
     >;
}// namespace
...
class FrameImpl : public
   cc_tools_qt::ToolsFrameBase<
       ...
       ProtFrame,
       cc_tools_qt_plugin::Message::cc_demo1::factory::MsgFactory,
       cc_tools_qt_plugin::Message::cc_demo1::frame::FrameTransportMessage
   >
{
};
